...
//        }
        ...
        fun assertJSONFormat(json: JsonObject, expectedContent: String, endpoint: Endpoint) {
    ...
    enum class Endpoint {
        TEXT {override val firebaseDescriptor = TextRecognitionRequest.requestDescriptor},
        OBJECT {override val firebaseDescriptor = ObjectRecognitionRequest.requestDescriptor};
